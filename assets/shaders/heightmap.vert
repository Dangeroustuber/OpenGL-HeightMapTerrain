...
smooth out float heightCol; // technique inspired by this https://www.reddit.com/r/opengl/comments/9dk5mn/texturecolor_terrain_depending_on_its_height/
out vec4 vCol;
out vec2 TexCoord;
out vec3 Normal;
out vec3 FragPos;
...
void main()
{
	...
	heightCol = pos.y; // only supposed to "color" different heights not xz	
	TexCoord = tex;
