...
// Structs are created for each light, makes it easier to avoid
// code repitition
struct Light
{
	vec3 colour;
...
vec4 CalcLightByDirection(Light light, vec3 direction)
{
	...
	vec4 specularColour = vec4(0, 0, 0, 0); // Set to zero, like we have no specular color
